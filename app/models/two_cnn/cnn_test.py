...
# 모델 로드
# model = tf.keras.models.load_model("app/models/two_cnn/cnn_model_250226_1.h5")
...
model = tf.keras.models.load_model("app/models/two_cnn/cnn_model_250226_1.h5") # '/' 로 형식 변경함. 절대 경로 필요.
